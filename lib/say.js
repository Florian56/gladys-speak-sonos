...
module.exports = function(params){
	...
	return gladys.modules.sonos.music.getQueue(deviceType)
		...
		.then(currentTrack => [gladys.modules.sonos.music.getPlaying(deviceType), currentTrack])
		.spread((isPlaying, currentTrack) => {
			return [
				isPlaying,
				currentTrack,
		...
		.spread((isPlaying, currentTrack) => resumePlaylist(deviceType, firstTtsTrackQueuePosition, isPlaying, currentTrack));
};